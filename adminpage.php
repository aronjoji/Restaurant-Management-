...
// Query to get the total number of orders with a status of 'collected'
$cres = mysqli_query($con, "SELECT * FROM sales WHERE status = 'collected'");
$totalOrders = mysqli_num_rows($cres);
...
$sql = "SELECT sdate, SUM(totalamt) AS total_amount FROM sales GROUP BY sdate ORDER BY sdate";
