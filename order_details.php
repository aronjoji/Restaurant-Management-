...
<!-- Mirrored from salero.dexignzone.com/codeigniter/demo/order_details by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Sep 2023 12:59:36 GMT -->
...
session_start();
$id=$_GET['id'];
$cres=mysqli_query($con,"select * from sales_sub where salesno='$id'");
								...
								<div class="dropdown-menu dropdown-menu-end" style="">
									<div class="card border-0 mb-0">
										<div class="card-header py-2">
											<div class="products">
												<img src="public/assets/images/user.jpg" class="avatar avatar-md" alt="">
												<div>
        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="editpr">Edit Product</a></li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Users Manager<span class="badge badge-danger badge-xs ms-1">NEW</span></a>
                        <ul aria-expanded="false">
                            ...
                            <li><a href="app_profile_2.html">Profile 2 <span class="badge badge-danger badge-xs ms-1">NEW</span></a></li>
            ...
            <li><a href="svg_icons.html" class="" aria-expanded="false">
                <div class="menu-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                ?>
								<div class="food-items-bx">
									<div class="food-items-media">
										<img src="adm/public/assets/images/favirate-img/5.png" alt="">
									</div>
									<div class="d-flex align-items-end">
										<div class="food-items-info">
											<span class="text-primary">FOOD</span>
											<h6><?php echo $result['pname'];?> </h6>
											<span><?php echo $result['quantity'];?></span>
										</div>
										<div class="d-inline-flex text-nowrap">
											<span class="me-2"><?php echo $result['price'];?></span>
											<h6 class="mb-0 text-primary"><?php echo $result['total'];?></h6>
										</div>
									</div>
...
<div class="container">
    <form  method="post">
        <select id="numberDropdown" name="counter">
            <option value="">Select Counter</option>
            <?php
            for ($i = 1; $i <= 10; $i++) {
				$ds=mysqli_query($con,"select * from sales where counterno='$i'");
        ...
        <!-- Pass salesno as a query parameter in the form action URL -->
