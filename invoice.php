...
<!-- Mirrored from salero.dexignzone.com/codeigniter/demo/ecom_invoice by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Sep 2023 12:59:58 GMT -->
...
if (isset($_GET['order_id'])) {
    $id = $_GET['order_id'];
    $cres = mysqli_query($con, "SELECT * FROM sales WHERE salesno='$id'");

    if ($cres) {
        $result = mysqli_fetch_assoc($cres); // Fetch and store the data in $result

        // Check if 'salesno' key exists in $result before using it
        if (isset($result['salesno'])) {
            $invoiceNumber = $result['salesno'];
            // You can also retrieve and format other data you need from $result here
        } else {
            echo 'Sales number not found.';
        }
...
<div class="content-body">
	<div class="container">
		...
		<div class="row">
			...
			<div class="card mt-3">
    <div class="card-header"> Invoice <strong><?php echo isset($invoiceNumber) ? $invoiceNumber : 'N/A'; ?></strong> <span class="float-end">
								...
								<div class="row align-items-center">
									<div class="col-sm-9"> 
										<div class="brand-logo mb-2 inovice-logo">
												...
												<svg class="brand-title ms-2" width="108" height="47" viewBox="0 0 108 47" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<div class="col-sm-3 mt-3"> <img src="public/assets/images/qr.png" alt="" class="img-fluid width110"> </div>
								</div>
							</div>
						</div>
...
<!-- Mirrored from salero.dexignzone.com/codeigniter/demo/ecom_invoice by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Sep 2023 12:59:59 GMT -->
</html>