...
<!-- Mirrored from salero.dexignzone.com/codeigniter/demo/order_list by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Sep 2023 12:59:35 GMT -->
...
<?php
include 'conn.php';
$cres=mysqli_query($con,"select * from sales where status='new order'");
?>
						...
						<ul class="contacts">
							...
							<li class="active dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="adm/public/assets/images/avatar/1.jpg" class="rounded-circle user_img" alt="">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="adm/public/assets/images/avatar/2.jpg" class="rounded-circle user_img" alt="">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="adm/public/assets/images/avatar/3.jpg" class="rounded-circle user_img" alt="">
										<span class="online_icon"></span>
									</div>
									<div class="user_info">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="adm/public/assets/images/avatar/4.jpg" class="rounded-circle user_img" alt="">
										<span class="online_icon offline"></span>
									</div>
									<div class="user_info">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="adm/public/assets/images/avatar/5.jpg" class="rounded-circle user_img" alt="">
										<span class="online_icon offline"></span>
									</div>
									<div class="user_info">
					...
					<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
						<div class="d-flex justify-content-start mb-4">
							<div class="img_cont_msg">
								<img src="adm/public/assets/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="">
							</div>
						...
						<ul class="contacts">
							<li class="active">
								<div class="d-flex bd-highlight">
									...
									<div class="ms-auto">
										<a href="adm/javascript:void(0);" class="btn btn-primary btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
										<a href="adm/javascript:void(0);" class="btn btn-danger btn-xs sharp"><i class="fa fa-trash"></i></a>
									</div>
								</div>
							</li>
							<li>
        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
				...
				<li><a href="sales.php">Sales Report</a></li>
                    ...
                    <li><a href="editpr.php">Edit product</a></li>
		...
		<div class="row">
            ...
            while($result=mysqli_fetch_array($cres))
            {
				...
				<tr>
												...
												<td></td>
												<td><span><?php echo $result['salesno'];?></span></td>
												<td><span><?php echo $result['sdate'];?></span></td>
												<td><span><?php echo $result['username'];?></span></td>
												
												<td><span><?php echo $result['totalamt'];?></span></td>
												<td><span class="badge badge-rounded badge-outline-primary badge-lg"><?php echo $result['status'];?></span></td>
												<td>
													<div>
													<a href="order_details.php?id=<?php echo $result['salesno'];?>"> View more + </a>
...
<div class="footer">
    ...
    <div class="copyright">
	<p>Copyright © Developed by <a href="https://www.instagram.com/aron.joji_/" target="_blank">Aron Joji</a> 2023</p>
    </div>
</div>
<!--**********************************
    Footer end
***********************************-->        
	        ...
	        <script src="adm/public/assets/vendor/datatables/js/jquery.dataTables.min.js"></script>
            <script src="adm/public/assets/js/plugins-init/datatables.init.js"></script>
